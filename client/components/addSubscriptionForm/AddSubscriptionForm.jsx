    ...
    <form
      ...
      <label htmlFor='nameInput'>
        <div>
          ...
          <input className='nameInput' type='text' placeholder='Company name' required  name='name'></input>
        </div>
      </label>
      <label htmlFor='amountInput'>
        <div>
          <span className='fa fa-usd fa-lg'></span>
          <input className='amountInput' type='text' pattern='\d+\.\d{1,2}' placeholder='Payment amount' required name='amount'></input>
        </div>
      </label>
      <label htmlFor='dateInput'>
        <div>
          <span className='fa fa-calendar fa-lg'></span>
          <input className='dateInput' type='date' required name='date'></input>
        </div>
      </label>
